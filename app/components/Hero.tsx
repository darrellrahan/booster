...
function Hero() {
  return (
    <section id="hero" className="h-screen text-white">
      <div className="h-[85%] bg-[url('/hero-bg.svg')] lg:bg-[url('/hero-bg-lg.svg')] bg-cover relative">
      ...
      <div className="h-[15%] bg-[#2281D5] flex items-center">
